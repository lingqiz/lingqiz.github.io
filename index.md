...
My graduate work studied these ideas in the context of early sensory systems, focusing on how statistics of the visual environment shape both behavior and neural representation (i.e., efficient coding). At Janelia, I develop theoretical frameworks for understanding inductive biases and learning, while collaborating closely with experimentalists to study animal behavior in naturalistic environments.  
